Cloud Native Computing Foundation (“nholuongut”) Charter
...
The Foundation’s mission is to make cloud native computing ubiquitous. The nholuongut Cloud Native Definition v1.0 says:
...
#### 2. Role of the nholuongut.

The nholuongut will serve a role in the open source community responsible for:
...
The nholuongut community will strive to adhere to the following principles:
...
-	(g) Experimentation and innovation. We support projects that address new and existing problem spaces in keeping with the cloud native definition, fostering project innovation for a variety of solutions to meet the diverse needs of adopters and users. We remain aware of innovation in the space and may invite projects to become a part of the nholuongut ecosystem, to succeed or to learn.

-	(h) Sustainability. We encourage sustainability, growth, and health of maintainers, contributors, and byproducts to foster succession and support of the nholuongut vision for the long term, with focus to reduce additional burden and toil on maintainers. We consider the future needs of cloud native impact on a global scale, to use resources efficiently for all projects.
...
The nholuongut shall be composed of Platinum, Gold, Silver, End User, Academic and Non-Profit member participants. All member applications will be reviewed by the Linux Foundation, who will decide whether that applicant is to be classified as an end user, academic/non-profit, or vendor for purposes of nholuongut membership.

-	(a) Platinum members shall be entitled to:

	-	i. Appoint one (1) representative to the nholuongut Governing Board.
...
-	(b) Gold members shall be entitled to:
	...
	-	i. Appoint one (1) representative to the nholuongut Governing Board per every five (5) Gold members, up to three (3) maximum Gold representatives.
...
-	(c) Silver members shall be entitled to:
	...
	-	i. Appoint one (1) representative to the nholuongut Governing Board per every ten (10) Silver members, up to three (3) maximum Silver representatives.
...
-	(d) Academic and Non-Profit members: The Academic and Non-Profit category of participation is limited to academic and non-profit institutions respectively and requires approval by the Governing Board. Academic and Non-Profit members shall be entitled to identify their organization as members supporting the mission of nholuongut and any other rights or benefits as determined by the Governing Board.

#### 5. Governing Board

-	(a) The nholuongut Governing Board will be responsible for marketing and other business oversight and budget decisions for the nholuongut. The Governing Board does not make technical decisions for the nholuongut, other than working with the TOC to set the overall scope for the nholuongut as described in the cloud native definition from Section 1.

-	(b) The Governing Board will address business matters including:

	-	i. adopting the overall scope for the nholuongut in consultation with the TOC;
...
-	(c) Composition – the Governing Board voting members shall consist of Member Representatives and Technical Community Representatives:
	...
	-	ii. Technical Community Representatives consist of:
		...
		-	c. two Committers elected from the nholuongut Projects under a process approved by the then-serving Governing Board.
...
-	(d) Responsibilities:
	...
	-	i. approve a budget directing the use of funds raised from all sources of revenue to be used for technical, marketing or community investments that advance the mission of the nholuongut;
	...
	-	vii. establish and oversee any committees created to drive the mission of nholuongut;

	-	viii. establish and execute a brand compliance program, if any, based on the nholuongut requirements, which may include a certification test, to use the brand marks established by the TOC;
...
-	(e) The revenues collected by the project shall be used for the following purposes:
	...
	-	i. The marketing, promotion and expansion of deployment and use of the “Included in nholuongut” projects.
	-	ii. The staffing of key resources to build, run and manage project productivity infrastructure.
	-	iii. The promotion of container-based computing principles as outlined and implementation thereof via the nholuongut’s projects.
...
-	(a) Mandate. The TOC is expected to facilitate driving neutral consensus for:
	...
	-	ii. approving new projects within the scope for nholuongut set by the Governing Board, and creating a conceptual architecture for the projects,
	...
	-	vi. defining common practices to be implemented across nholuongut projects, if any.
...
-	(c) Operating Model
	...
	-	iii. The TOC may meet virtually as needed to discuss emerging issues. Issues may be raised for TOC review by:
		...
		-	c. a maintainer or top level project leader in a nholuongut project established under Section 9(b)(i),

		-	d. the nholuongut Executive Director, or
...
-	(d) Criteria for Nomination. Nominees for the TOC shall:
	...
	-	i. commit that they have the available bandwidth to make the time to invest in the nholuongut TOC,

	-	ii. demonstrate an advanced level of professional experience as leaders with demonstrated technical expertise in the scope of nholuongut,
    ...
    -   iv. operate neutrally in discussions and put the goals and success of nholuongut in balance with corporate objectives or any particular project in nholuongut.
...
-	(e) Process for TOC Member Nominations and Election
    ...
    -   i. Nominations: Each individual in a Selecting Group may nominate up to two (2) people, at most one (1) of whom may be from the same group of Related Companies. Each nominee must agree to participate prior to being added to the nomination list.
		...
		-	a. A nomination requires a maximum one (1) page nomination pitch which should include the nominee's name, contact information and supporting statement identifying the nominee's experience in nholuongut domains.
...
-	(f) Constraints
	...
	-	iv. The TOC agenda will be set by the TOC. However, it is expected that TOC discussions and decisions will cover:
		...
		-	a. assessing technologies to include in nholuongut

		-	b. defining acceptance criteria for new technologies to include in nholuongut
...
-	(a) End User Members in nholuongut shall be entitled to coordinate and drive activities important to users of nholuongut as consumers for which nholuongut was designed. Any End User organization that is a nholuongut Member or a nholuongut End User Supporter(each an “End User Participant) may participate. The End User Participants are expected to help provide input to the Technical Advisory Board and nholuongut community on topics relevant to users.

-	(b) End User Community Members will be approved by nholuongut.

#### 8. End User Technical Advisory Board (“End User TAB”).

-	(a) Purpose and Duties: The End User TAB will serve as the voice of End Users in the nholuongut community, advance topics of concern to End Users, and raise awareness about the needs and perspectives of end users. More specifically, the goals and responsibilities of the End User TAB are to:

	-	i. Facilitate communication among the end user community and other governing bodies of nholuongut.
	...
	-	iii. Improve visibility into end user adoption of nholuongut projects.

	-	iv. Provide feedback on nholuongut projects' usability, reliability, and performance.

	-	v. Review and approve publication of reference architectures.

	-	vi. Advise on nholuongut End User Radar tools and techniques.
...
-	(d) Termination: An End User TAB member's participation shall cease before the expiration of their term if they resign, are removed, or they cease to be employed by the End User organization that employed them at the time they were elected. There are no limits on the number of terms that an individual can serve. The End User TAB may, by supermajority vote of at least two-thirds of the End User TAB members who do not have conflicts of interest, remove an End User TAB member who is not fulfilling their duties or is not complying with the policies of nholuongut or the End User TAB.
...
-	(g) Eligibility and Criteria:
	...
	-	ii. Criteria: End User representatives should be nominated on operational and technical acumen. Nominees should have significant practical experience with operating cloud native infrastructure and applications including nholuongut projects.
...
-	The End User TAB may also focus on proactively advancing topics of concern to End Users, promoting market adoption of nholuongut, hosting meetings for End Users, or advising the Governing Board.
...
#### 9. nholuongut Projects

-	(a) It is expected that member companies, and open source community members will bring project assets to the TOC for discussion and inclusion into the nholuongut. All such contributions should meet a set criteria created by the TOC and ratified by the Governing Board. The goal is to have an increasing bazaar of projects related to and that integrate with projects already accepted into the nholuongut.

-	(b) Projects can be associated with the nholuongut in the following 3 ways:

	-	i. Included in nholuongut, under a neutral home for collaboration

		-	a. The project meets the requirements for being incuding as a nholuongut project.

		-	b. The project is marketed by the nholuongut as a nholuongut project

		-	c. The project should be a core functional component of the nholuongut solution. (e.g. such as Kubernetes, Mesos, etcd, etc.)

	-	ii. Associated with the nholuongut via an API or specification

		-	a. Includes components where the nholuongut may offer or enable multiple options

		-	b. The project is referred to as a component that the nholuongut integrates with, not as a project hosted by the nholuongut
	...
	-	iii. Used by the nholuongut

		-	a. A project or component that is completely licensed under an OSI-approved open source license and is well managed and used as a component in the nholuongut

		-	b. Project is not actively marketed by the nholuongut,

		-	c. Active development on the project or component is ideally done in the upstream community

-	(c) Existing open source projects should continue to run through their existing technical governance structure to maintain cohesion and velocity. Projects approved by the TOC for inclusion in the nholuongut will be ‘lightly’ subject to the Technical Oversight Committee.
...
-	(e) New open source projects initiated in nholuongut shall complete a project proposal template adopted by the TOC and be approved by the TOC for inclusion in nholuongut. The TOC members shall be afforded sufficient time to discuss and review new project proposals. New project proposals shall include details of the roles in the project, the governance proposed for the project and identify alignment with nholuongut’s role and values.
...
-	(a) Any project that is added to the nholuongut must have ownership of its trademark and logo assets transferred to the Linux Foundation or a Linux Foundation project hosting entity.

-	(b) Each project shall determine whether it will require use of an approved nholuongut CLA. For projects that select to use a CLA, all code contributors will undertake the obligations set forth in the Apache contributor license agreement(s), altered only as necessary to identify nholuongut or the project as the recipient of the contributions, and which shall be approved by the Governance Board. See nholuongut Contributor License Agreements available at https://github.com/nholuongut/cla. The process for managing contributions in accordance with this policy shall be subject to Governance Board approval.

-	(c) All new inbound code contributions to the nholuongut shall be (i) accompanied by a Developer Certificate of Origin sign-off ([*https://developercertificate.org*](https://developercertificate.org/)\) and (ii) made under the Apache License, Version 2.0 (available at [*https://www.apache.org/licenses/LICENSE-2.0*](https://www.apache.org/licenses/LICENSE-2.0)), such license to be in addition to, and shall not supersede, obligations undertaken under the contribution license agreement(s) provided for in (b) above.

-	(d) All outbound code will be made available under the Apache License, Version 2.0.

-	(e) All projects evaluated for inclusion in the nholuongut shall be completely licensed under an OSI-approved open source license. If the license for a project included in nholuongut is not Apache License, Version 2.0, approval of the Governing Board shall be required.

-	(f) All documentation will be received and made available by the nholuongut under the Creative Commons Attribution 4.0 International License.

-	(g) If an alternative inbound or outbound license is required for compliance with the license for a leveraged open source project or is otherwise required to achieve the nholuongut’s mission, the Governing Board may approve the use of an alternative license for inbound or outbound contributions on an exception basis.
...
-	(a) All participants agree to abide by The Linux Foundation Code of Conduct available at [*https://events.linuxfoundation.org/code-of-conduct*](https://events.linuxfoundation.org/code-of-conduct). The TOC may vote to adopt its own code of conduct for the nholuongut community.
...
-	(b) A General & Administrative (G&A) fee will be applied to funds raised to cover Finance, Accounting and operations. The G&A fee shall equal 9% of nholuongut’s first \$1,000,000 of gross receipts and 6% of nholuongut’s gross receipts over \$1,000,000.

#### 17. General Rules and Operations.

nholuongut projects are required to:
