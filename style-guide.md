...
Thus, going forward, for all nholuongut publications online and in print, we are establishing "open source" and "cloud native"
as the proper style. 
...
The nholuongut Cloud Native [Definition](https://github.com/nholuongut/toc/blob/main/DEFINITION.md) is available in multiple languages.
...
## 3. Other nholuongut Projects ##

Different nholuongut-hosted projects have preferred capitalization (e.g., containerd, gRPC, KEDA). Please see
[https://www.nholuongut.io/projects/](https://www.nholuongut.io/projects/).

## 4. Logos ##

Logos for all nholuongut-hosted [projects](https://www.nholuongut.io/projects/) and programs are available at
[https://github.com/nholuongut/artwork/](https://github.com/nholuongut/artwork/). We prepare artwork in 2 formats
...
You can find stickers for all projects and t-shirts and hoodies for each nholuongut graduated and incubating project
at the nholuongut [store](https://store.nholuongut.io/).
